...
const BuyCarforMeLocationScreen = () => {
  ...
  const handleSelect = (city: string) => {
    navigation.navigate(returnTo, { selectedLocation: city })
  }

  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}><Text style={styles.headerTitle}>Select Location</Text></View>
...
export default BuyCarforMeLocationScreen

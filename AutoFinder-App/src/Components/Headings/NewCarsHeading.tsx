...
type NavigationProps = StackNavigationProp<RootStackParamList, "NewCarListScreen">;

const NewCarHeading = ({ heading, label }: { heading: string; label?: string }) => {

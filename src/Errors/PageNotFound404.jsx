    ...
    <Helmet>
      <title>404 | Page Not Found</title>
        ...
        <div className="text">
          ...
          <h3>Page Not Found - let's take you BACK</h3>
          <div style={{ marginTop: '2rem' }}>
            <Link 
              ...
              onMouseEnter={(e) => e.target.style.backgroundColor = '#F55F44'}
              onMouseLeave={(e) => e.target.style.backgroundColor = '#F66947'}
            >
              Go Back Home
            </Link>
          </div>
